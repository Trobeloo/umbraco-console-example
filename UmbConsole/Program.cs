...
{
    class UmbracoRunner : MarshalByRefObject
    {
        ...
        public ApplicationContext InitializeApplication()
        {
...
//            var dataDirectory = UmbracoRunner.Application.DataDirectory;
